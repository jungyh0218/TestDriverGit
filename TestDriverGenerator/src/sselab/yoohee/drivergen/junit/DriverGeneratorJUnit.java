...
import sselab.yoohee.drivergen.DriverGenerator;
import sselab.yoohee.drivergen.FunctionCall;

public class DriverGeneratorJUnit {
	...
	public void testConstruction(){
		initialize();
		DriverGenerator dg = new DriverGenerator(statements);
		for(FunctionCall s : dg.calls){
			System.out.println(s.callExpr.getRawString());
		}
	}
